...
EXTREME_SPACE_SIZE = 20  # Space size for Extreme mode
SNAKE_COLOR = None
BODY_PARTS = 5
FOOD_COLOR = "#ADFF2F"
...
def select_game_mode():
    ...
    # Adding instruction text for mode selection
    mode_label = tk.Label(mode_window, text="Please select your mode", font=('consolas', 30), fg="lime green")
    mode_label.pack(pady=20)
    mode_label.place(relx=0.5, y=200, anchor='center')
...
def select_snake_color():
    ...
    color_label = tk.Label(color_window, text="Please select your color", font=('consolas', 30), fg="lime green")
    color_label.pack(pady=20)
    color_label.place(relx=0.5, y=100, anchor='center')

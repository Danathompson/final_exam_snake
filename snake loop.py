...
def game_over():
    ...
    canvas.create_window(GAME_WIDTH // 2, GAME_HEIGHT // 2 + 20, window=play_again_button)
    canvas.create_window(GAME_WIDTH // 2, GAME_HEIGHT // 2 + 70, window=quit_button)
